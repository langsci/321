...
%% Statistics
\newcommand{\clmmLR}[2]{($\chi^2 = #1, p < #2$)}
\newcommand{\clmmLRbr}[2]{$\chi^2 = #1,$\linebreak $p < #2$}
\newcommand{\clmmLRnonsig}[2]{($\chi^2 = #1, p > #2$)}
\newcommand{\glmer}[2]{($\chi^2 = #1, p < #2$)}
\newcommand{\glmernonsig}[2]{($\chi^2 = #1, p > #2$)}
\newcommand{\lm}[3]{($F(#1) = #2, p < #3$)}
\newcommand{\lmnonsig}[3]{($F(#1) = #2, p > #3$)}
\newcommand{\correlation}[3]{($Pearson's\;r^2 = #1, t = #2, p < #3$)}
\newcommand{\highsig}{0.001}
\newcommand{\descriptives}[2]{($\mu = #1, \sigma = #2$)}
\newcommand{\marginal}{{\large\textsuperscript{.}}}

% currency
\newcommand{\currencyEuro}[1]{{\geneuro #1}}
\newcommand{\currencyPound}[1]{{\pounds #1}}
\newcommand{\currencyDollar}[1]{{\textdollar #1}}
