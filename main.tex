...
The first part of the book is dedicated to the sytactic analysis of fragments, which is investigated with experimental methods. Currently, there are competing theoretical analyses of fragments, which relied almost only on introspective judgements. The experiments presented in this book consistitute a first systematic evaluation of their predictions and, taken together, support an in situ ellipis account of fragments, as has been suggested by Reich (2007).
