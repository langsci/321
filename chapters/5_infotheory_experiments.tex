...
\begin{equation}
 \displaystyle S(w_n) = \log_2 \left(\frac{\alpha_{n-1}}{\alpha_n}\right)
\end{equation}
...
\begin{equation}
 \displaystyle S(pour) = \log_2 \left(\frac{1}{0.97} = 0.04\right) \label{eq:surprisal-pour}
\end{equation}
...
\begin{equation}
 \displaystyle S(pasta\mathbin{|}pour) = \log_2 \left(\frac{0.97}{0.75}\right) = 0.37 \label{eq:surprisal-pasta}
\end{equation}
\is{Parser, parallel|)}
...
\begin{equation}
S(pasta) = \log_2 \left(\frac{1}{0.75}\right) = 0.42 \label{eq:pasta-s}
\end{equation}
...
\begin{equation}
S(pot.GOAL\mathbin{|}pour) = \log_2 \left(\frac{0.97}{0.95}\right) = 0.03
\end{equation}
...
\begin{equation}
\displaystyle S_{scaled} = \log_2 \left(\frac{\alpha_{i-1}}{\alpha_i \times \sum_{x\in W_{Alt}}{\alpha_x}}\right) \label{eq:hale-s-alt}
\end{equation}
...
\begin{equation} 
 \displaystyle Reduction(w_i, w_{i+1}) = \log_2 \left(\frac{\alpha_{w_{i+i}}}{\alpha_{w_i, w_{i+1}}}\right) \label{eq:sreduction}
\end{equation}
...
\begin{equation} 
 \displaystyle Reduction(pasta, pot.GOAL) = \log_2 \left(\frac{0.97}{0.75}\right) = 0.34
\end{equation}
