...
\begin{sloppypar}\noindent
\citeauthor{merchant2004} argues that this challenges \textit{in situ} deletion accounts\is{In situ deletion account} of fragments, which must explain why the complementizer cannot be omitted\is{Complementizer omission} in fragments even though this is possible in full sentences when the CC\is{Complement clause} appears \textit{in situ}.\end{sloppypar}
