...
\ex. \ag. Nimm  den Topf mit den Nudeln vom Herd.\\
     ...
     \bg. Deck doch schon nmal den Küchentisch.\\
	  set.\textsc{imp} already \textsc{prt} already the.\textsc{acc} kitchen.table\\
